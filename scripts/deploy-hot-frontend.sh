...
gcloud builds submit --config cloudbuild-frontend.yaml \
  --substitutions _AI_URL="${AI_URL}",_GUARDIAN_URL="${GUARDIAN_URL}",_ENGINE_URL="${ENGINE_URL}",_DISABLE_FIREBASE="true",_MAPS_KEY="${NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}",_CACHE_BUSTER=SOVEREIGN_FORCE_$(date +%s) .
