...
gcloud run deploy promethea-frontend \
  ...
  --set-env-vars "NEXT_PUBLIC_AI_SERVICE_URL=https://ai-service-385120524005.us-central1.run.app,NEXT_PUBLIC_GUARDIAN_URL=https://authentication-service-385120524005.us-central1.run.app,NEXT_PUBLIC_ENGINE_URL=https://economic-engine-385120524005.us-central1.run.app,NEXT_PUBLIC_LEDGER_URL=https://sovereign-ledger-385120524005.us-central1.run.app,NEXT_PUBLIC_FIREBASE_PROJECT_ID=studio-9105849211-9ba48,NEXT_PUBLIC_DISABLE_FIREBASE=true,CONSERVATION_MODE=false,ECONOMIC_ENGINE_URL=https://economic-engine-385120524005.us-central1.run.app,AI_SERVICE_URL=https://ai-service-385120524005.us-central1.run.app,GUARDIAN_URL=https://authentication-service-385120524005.us-central1.run.app" \
  --memory 1Gi \
  --cpu 1 \
  --min-instances 0 \
  --timeout 300
