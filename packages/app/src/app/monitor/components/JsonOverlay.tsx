        ...
        <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-xl flex items-center justify-center p-8">
            <div className="w-full max-w-4xl bg-gray-950 border border-gray-800 rounded-3xl shadow-2xl flex flex-col h-[80vh]">
                <div className="p-6 border-b border-gray-800 flex justify-between items-center">
                    <h2 className="text-xl font-black italic">AGENT STATE INGESTION <span className="text-amber-500">JSON</span></h2>
                ...
                <div className="flex-1 p-6 font-mono text-xs">
                    <textarea
                        ...
                        className="w-full h-full bg-gray-900 border border-gray-800 rounded-xl p-4 text-amber-400 focus:outline-none focus:border-amber-500 transition-colors resize-none"
                ...
                <div className="p-6 border-t border-gray-800 flex gap-4">
                    ...
                    <button onClick={handleApply} className="flex-1 py-2 bg-orange-600 hover:bg-amber-500 rounded-xl text-xs font-black uppercase shadow-lg shadow-orange-900/20">Apply Evolution State</button>
                </div>
            </div>
        </div>
    );
