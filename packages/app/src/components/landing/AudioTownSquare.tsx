...
export const AudioTownSquare: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#111625] text-[#F9FAFB] font-sans flex flex-col justify-between p-6 rounded-3xl border border-gray-800 shadow-2xl my-6">
      
      {/* --- TOP BAR (PILLAR NAVIGATION) --- */}
      <header className="flex justify-between items-center border-b border-gray-800 pb-4">
        <div className="flex items-center space-x-3">
          <span className="text-[#F59E0B] text-2xl font-bold">⬤</span>
          <span className="font-semibold tracking-wider text-sm">TPNS SPATIAL AUDIO COMMONS</span>
        </div>
        <div className="hidden md:flex space-x-6 text-xs tracking-wider uppercase text-gray-400">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs uppercase tracking-wider text-gray-400 font-semibold">
                  {inRoom ? 'Live Spatial Audio Community Room' : 'Voice Commons Offline'}
                </span>
              </div>
