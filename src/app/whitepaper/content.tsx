    ...
    <div className={cn("prose prose-lg max-w-none text-foreground/90 dark:prose-invert prose-headings:font-headline prose-headings:tracking-tight prose-p:leading-relaxed prose-h2:text-3xl prose-h3:text-2xl prose-h4:text-xl", "prose-numbered pl-14")}>
      ...
      <Section>
       ...
       <Section>
        ...
        <h4 className="text-center mb-4 mt-8">II. The Identity Genesis Database (Authenticator Application)</h4>
        <P>The first body serves as the secure, one-time "genesis block" for a new citizen's identity. Its sole purpose is to act as a trusted on-ramp from legacy authentication methods to a true Self-Sovereign Identity (SSI). The database associated with this authenticator application is ephemeral in its relationship with the user but foundational in its function. When a prospective member initiates the creation of a Promethean Passport, this system generates the static, immutable anchor of the citizen's identity: a new, unique cryptographic wallet address and its corresponding private key. Upon successful generation, this entire identity package is securely transferred to the user's local sovereign environment (DepthOS), and the authenticator's database purges any sensitive temporary data used during the creation process. Its role is not to manage the identity, but to safely mint it and cede control to its rightful owner.</P>
      ...
      <Section>
        <h4 className="text-center mb-4 mt-8">II. The Identity Genesis Database (Authenticator Application)</h4>
        <P>The first component serves as the secure, one-time "genesis block" for a new citizen's identity. Its sole purpose is to act as a trusted on-ramp from legacy authentication methods to a true Self-Sovereign Identity (SSI). The database associated with this authenticator application is ephemeral in its relationship with the user but foundational in its function. When a prospective member initiates the creation of a Promethean Passport, this system executes two critical, cryptographically-bound operations.</P>
